...
class Menu {
    ...
    init(titleName: String? = nil, subtitleNameLabel: String? = nil, mode: ProfileMenuCellMode, iconImageName: String? = nil, iconViewBgColor: UIColor? = nil, separatorLine: Bool) {
...
class ProfileMainViewModel {
    ...
    init() {
        ...
        let ownerProfile = Menu(titleName: "Owner profile", subtitleNameLabel: "Maxwell Beard", mode: .textUI, iconImageName: "person.fill", iconViewBgColor: .iconBgBlue, separatorLine: true)
        let partnerDetails = Menu(titleName: "Partner details", subtitleNameLabel: "Postcode", mode: .textUI, iconImageName: "at", iconViewBgColor: .iconBgBlue, separatorLine: true)
        let openHours = Menu(titleName: "Open hours", subtitleNameLabel: "24/7", mode: .textUI, iconImageName: "phone.fill", iconViewBgColor: .iconBgBlue, separatorLine: false)
